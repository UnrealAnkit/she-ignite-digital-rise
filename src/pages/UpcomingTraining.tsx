                  ...
                  <div key={training.id} className={`group relative overflow-hidden rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-4 ${cardVariant}`}>
                    ...
                    <div className="relative p-8">
                      ...
                      {training.materials_included && training.materials_included.length > 0 && (
                        <div className="mb-6">
                          <h4 className="text-sm font-bold mb-3 text-gray-900">What's Included:</h4>
                          <div className="space-y-2">
                            {training.materials_included.slice(0, 3).map((material, materialIndex) => (
                      ...
                      {training.topics && training.topics.length > 0 && (
                        <div className="mb-6">
                          <p className="text-sm font-bold mb-2 text-gray-900">Topics covered:</p>
                          <div className="flex flex-wrap gap-2">
                            {training.topics.slice(0, 3).map((topic, topicIndex) => (
                              <Badge key={topicIndex} className={`text-xs ${badgeColor} border font-medium`}>
                                {topic}
                              </Badge>
                            ))}
                            {training.topics.length > 3 && (
                              <Badge className={`text-xs ${badgeColor} border font-medium`}>
